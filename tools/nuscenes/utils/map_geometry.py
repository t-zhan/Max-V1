...
# Modified to remove unused dependencies and work as a standalone utility.
...
def get_ped_crossing_contour(polygon: Polygon,
    ...
    if lines.type != 'LineString':
        ...
        lines = [part for part in lines.geoms if part.geom_type != 'Point']
        lines = ops.linemerge(lines)
        ...
        if lines.type != 'LineString':
            ...
            for part in lines.geoms:
                ls.append(np.array(part.coords))
